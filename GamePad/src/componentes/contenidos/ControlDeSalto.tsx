...
const ControlDeSalto = ({ onCapturarLayout }: Props) => (
  <View style={estilos.contenedor} onLayout={onCapturarLayout}>
    {/* Placeholder para imagen de salto */}
    <View style={estilos.placeholderImagen}>
      <Text style={estilos.placeholderTexto}>Imagen aquí</Text>
    </View>
...
const estilos = StyleSheet.create({
  ...
  placeholderImagen: { marginBottom: 10, alignItems: "center" },
  placeholderTexto: { color: COLORES.TEXTO_CLARO, fontSize: 14 },
});

export default ControlDeSalto;
